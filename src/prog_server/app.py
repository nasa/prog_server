...
app.add_url_rule(PREFIX + '/session/<int:session_id>/observables', methods=['GET'], view_func=get_observables)
...
app.add_url_rule(PREFIX + '/session/<int:session_id>/prediction/observables', methods=['GET'], view_func=get_predicted_observables)
